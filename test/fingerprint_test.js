...
promise.then(obj => {
  ...
  // console.log('First fp:', JSON.stringify(obj, null, 2));
  ...
  // console.log('Second fp:', JSON.stringify(obj, null, 2));

  const segments = fp1.match(fp2);

  console.log('Match segments:', JSON.stringify(segments, null, 2));
  console.log('Done');
