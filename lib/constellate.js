...
module.exports = function(repoPath = '/tmp/constellate', serverAddr = 'http://127.0.0.1:8888') {
    ...
    let expand = true,
        fileHashes, files, ipld, keys, meta, metaHashes, names
    ...
    this.importContent = (files, password, cb) => {
