...
module.exports = function() {
    ...
    const pushIPLD = (service, privateKey, tasks, t, i) => {
        if (!ipld || !ipld.length) {
    ...
    */
    ...
    const getContent = (service, path, key, tasks, t, i) => {
    ...
    const importContent = (service, filez, password, tasks, t, i) => {
    ...
    this.importContent = (name, files, cb) => {
    ...
    this.getContent = (service, path, cb) => {
    ...
    this.IPFS = (repoPath = defaultRepoPath, cb) => {
        tasks.init(cb)
    ...
    this.pushIPLD = (name, privateKey, cb) => {
        tasks.init(cb)
        tasks.add(service => {
