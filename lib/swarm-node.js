...
function initSingletonSwarm(password) {
    return new Promise((resolve, reject) => {
...
function initTestnetSwarm(password) {
    return new Promise((resolve, reject) => {
        const datadir = newDatadir();
        const child = spawn('bash', [
...
function _runPrivateSwarm(maxpeers, networkid) {
    return (bzzkeys, datadir, password) => {
        let match;
        return new Promise((resolve, reject) => {
            const child = spawn('bash', [
...
function _runSingletonSwarm(networkid) {
    return (bzzkey, datadir, password) => {
        return new Promise((resolve, reject) => {
            const child = spawn('bash', [
                '../scripts/run-private-swarm.sh',
...
function runTestnetSwarm(bzzkey, datadir, password) {
    return new Promise((resolve, reject) => {
        const child = spawn('bash', [
