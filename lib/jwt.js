...
const jti = Object.assign({}, ClaimsId, {
    readonly: true
});
...
function calcClaimsId(claims, cb) {
...
function setClaimsId(claims, cb) {
    calcClaimsId(claims, (err, id) => {
        if (err) return cb(err, null);
        cb(null, Object.assign({}, claims, {
            'jti': id
        }));
    });
}
...
function validateClaims(claims, meta, cb) {
...
function verifyClaims(claims, header, meta, signature, cb) {
