...
function getAddr(party) {
    return getId('@id', party);
}

function setAddr(party, publicKey) {
...
function validateParty(party, publicKey, schema) {
    let valid = false;
    try {
