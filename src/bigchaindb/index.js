...
const errInvalidOwnerBefore = (ownerBefore: string): Error => new Error('invalid owner_before: ' + ownerBefore)
const errUnexpectedOperation = (operation: string): Error =>  new Error('unexpected operation: ' + operation)

const codec = 'bigchaindb-transaction'
const version = 1

const hashTx = (tx: Object): Buffer => {
  tx = clone(tx)
  delete tx.id
...
const Tx = {
  ...
  resolve: (tx: Object, path: string, tasks: Object, t: number, i?: number) => {
    if (!path || path === '/') {
...
const newEd25519Condition = (publicKey: string): Object => {
...
const conditionObject = (condition: Object): Object => {
...
const newCreateTx = (data: Object, sender: Object, metadata: ?Object, recipient: Object|Object[], tasks: Object, t: number, i?: number) => {
  const inputs = [{
    fulfillment: null,
    fulfills: null,
...
const newTransferTx = (sender: Object, metadata: ?Object, recipient: Object|Object[], tx: Object, tasks: Object, t: number, i?: number) => {
  let id
...
const signTx = (sender: Object, tx: Object, tasks: Object, t, i) => {
    tx = clone(tx)
    let ownersBefore
