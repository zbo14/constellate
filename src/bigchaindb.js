...
const pathFromCID = (cid: Object): string => {
...
const newCreateTx = (data: Object, issuer: Object, metadata: Object, owners: Object[], tasks: Object, t: number, i?: number) => {
  const inputs = [{
    fulfillment: null,
    fulfills: null,
...
const newTransferTx = (issuer: Object, metadata: Object, owners: Object[], tx: Object, tasks: Object, t: number, i?: number) => {
  const outputs = new Array(owners.length)
  let condition, publicKeys
  let j
...
const transformTx = (tx: Object): Object => {
...
const signTx = (issuer: Object, tx: Object, tasks: Object, t: number, i?: number) => {
  tx = cloneObject(tx)
  let ownersBefore
...
BigchainDB.MetadataService = function (url: string) {
  ...
  this.newTx = (node: Object, tasks: Object, t: number, i?: number) => {
    if (node.data) {
  ...
  this.get = (cid: Object, tasks: Object, t: number, i?: number) => {
    ...
    request(this.pathToIRI(pathFromCID(cid)), { json: true }, (err, json, res) => {
        if (err) {
