...
module.exports = function(options?: Object) {
    ...
    this.initPrivate = (password: string) => {
...
function _initTestnetSwarm(): Function {
  return (password: string): Promise<Object> => {
    return new Promise((resolve, reject) => {
      const datadir = newDatadir();
      const child = spawn('bash', [
...
function _runPrivateSwarm(bzzkeys: string[], datadir: string, maxpeers: number, networkid: number): Function {
...
function _runTestnetSwarm(bzzkey: string, datadir: string): Function {
  return (password: string): Promise<string> => {
    return new Promise((resolve, reject) => {
      const child = spawn('bash', [
...
function _addTestnetPeers(datadir: string): Function {
