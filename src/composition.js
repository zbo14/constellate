...
function Composition(
  composer: Header[], iswc: ?string, lyricist: ?Header[],
  publisher: ?Header[], recordedAs: ?Header[], title: string, url: string) {
    let i;
    this.composer = [];
...
Composition.prototype.addHeader = function(property: string, hasHeader: Header): boolean {
  switch (property) {
    case 'composer':
    case 'lyricist':
    case 'publisher':
...
Composition.prototype.validate = function(): ?Error {
