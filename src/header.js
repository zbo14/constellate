...
function Header(url: string) {
  this.id = base64_digest(this);
  this.url = url;
}

Header.prototype.calcId = function(): string {
  let copy = clone(this);
  delete copy.id;
  delete copy.url;
...
Header.prototype.getHeader = function(): Header {
  return new Header(this.url);
}

Header.prototype.addHeader = function(property: string, hasHeader: Header): boolean {
  return Header.prototype.add.call(this, property, hasHeader.getHeader());
}

Header.prototype.removeHeader = function(property: string, hasHeader: Header): boolean {
  return Header.prototype.remove.call(this, property, hasHeader.getHeader());
}

Header.prototype.add = function(property: string, value): boolean {
...
Header.prototype.remove = function(property: string, value: Object): boolean {
  if (!this.hasOwnProperty(property)) {
    return false;
  }
  if (!Array.isArray(this[property]) || value == null) {
